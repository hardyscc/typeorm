...
import { SybaseConnectionCredentialsOptions } from "./SybaseConnectionCredentialsOptions";
import { SybaseConnectionOptions } from "./SybaseConnectionOptions";
...
export class SybaseDriver implements Driver {
     ...
     * Connection options.
     */
    options: SybaseConnectionOptions;
    ...
    constructor(connection: Connection) {
        ...
        this.options = connection.options as SybaseConnectionOptions;
    ...
    parametrizeValue(column: ColumnMetadata, value: any) {
        ...
        if (value instanceof SybaseParameter) return value;
        ...
        return new SybaseParameter(value, normalizedType as any);
    }
    ...
    protected createPool(
        options: SybaseConnectionOptions,
        credentials: SybaseConnectionCredentialsOptions
    ): Promise<any> {
