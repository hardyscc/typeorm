...
import { SybaseDriver } from "../driver/sybase/SybaseDriver";
...
export class EntityMetadataBuilder {
    ...
    constructor(
        ...
        this.closureJunctionEntityMetadataBuilder = new ClosureJunctionEntityMetadataBuilder(
            connection
        );
    ...
    build(entityClasses?: Function[]): EntityMetadata[] {
        ...
        entityMetadatas
            ...
            .forEach(entityMetadata => {
                ...
                entityMetadata.relations
                    .filter(
                        relation => relation.isOneToOne || relation.isManyToOne
                    )
                    .forEach(relation => {
                        ...
                        if (uniqueConstraint) {
                            if (
                                ...
                                // } else {
                                relation.entityMetadata.uniques.push(
                                    uniqueConstraint
                                ); // todo: ownUniques is missing
                                // }
                                this.computeEntityMetadataStep2(entityMetadata);
                            }
                        }
                ...
                entityMetadata.relations
                    ...
                    .forEach(relation => {
                        ...
                        const junctionEntityMetadata = this.junctionEntityMetadataBuilder.build(
                            relation,
                            joinTable
                        );
        ...
        entityMetadatas.forEach(entityMetadata => {
            ...
            entityMetadata.hasNonNullableRelations = entityMetadata.relationsWithJoinColumns.some(
        ...
        entityMetadatas
            ...
            .forEach(entityMetadata => {
                const closureJunctionEntityMetadata = this.closureJunctionEntityMetadataBuilder.build(
                    entityMetadata
                );
    ...
    protected computeEntityMetadataStep1(
        ...
        if (entityMetadata.tableType === "entity-child") {
            const discriminatorColumn = entityMetadata.parentEntityMetadata.ownColumns.find(
