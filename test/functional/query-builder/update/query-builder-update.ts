...
import { SybaseDriver } from "../../../../src/driver/sybase/SybaseDriver";
                ...
                await connection
                    ...
                    .set({
                        name: () =>
                            ...
                            connection.driver instanceof SybaseDriver
                    ...
                    .where("name = :name", {
                        name: () =>
                            connection.driver instanceof SqlServerDriver ||
                            connection.driver instanceof SybaseDriver
                                ? "SUBSTRING('Alex Messer Dimovich', 1, 11)"
                                : "SUBSTR('Alex Messer Dimovich', 1, 11)"
                    })
                    .execute();
